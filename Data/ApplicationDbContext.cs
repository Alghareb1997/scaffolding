...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27C61480E6");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B40153B00E");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB855581B242");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__465962291D9DC476");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4239AAD61");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF52E54CFC3");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CE37F974C");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164BE941545").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D305243778");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C576EDB1E");
